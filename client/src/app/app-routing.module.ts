...
import { ReportsEditComponent} from './pages/reports-edit/reports-edit.component';
...
const routes: Routes = [
    ...
    { path: 'reportses/:id',  loadChildren: './pages/reports-edit/reports-edit.module#ReportsEditModule' , canActivate: [AuthGuard] },
    { path: 'reportses',  loadChildren: './pages/reports-list/reports-list.module#ReportsListModule' , canActivate: [AuthGuard] },
